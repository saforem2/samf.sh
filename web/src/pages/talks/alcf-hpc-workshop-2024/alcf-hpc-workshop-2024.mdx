...
date: '2024-10-29'
location: '2024 ALCF Hands-On HPC Workshop'
---
...
- [Why Distributed Training?
  Speedup!](#why-distributed-training-speedup)
    ...
    - [Going beyond Data Parallelism:
      ZeRO](#going-beyond-data-parallelism-b58fc729-690b-4000-b19f-365a4093b2ff7b7b3c2069636f6e696679206c6f676f73206d6963726f736f66742d69636f6e203e7d7d-zero)
...
Perform _reductions_ on data (e.g. `sum`, `min`, `max`) across ranks,
send result back to everyone.

<div id="fig-all-reduce">

<img src="/assets/collective-allreduce-sum.drawio.svg" loading="lazy" />
...
<img src="/assets/collective-reduce-sum.drawio.svg" loading="lazy" />
...
<img src="/assets/collective-broadcast.drawio.svg" loading="lazy" />

Figure 6: `broadcast` (_send_) a tensor <code>$x$</code> from one rank
to all ranks
...
<img src="/assets/collective-allgather.drawio.svg" loading="lazy" />
...
<img src="/assets/pipeline_parallelism.png" />
...
<img src="/assets/model-parallel.svg" />
...
<img src="/assets/parallelism-tp-parallel_gemm.png" />
...
<img src="/assets/parallelism-deepspeed-3d.png" />
...
<img src="/assets/emergent-abilities.gif" />
...
<video
    src="/assets/gpt3-training-step-back-prop.mp4"
    autoplay
    loop
    muted
    playsinline
...
Figure 22: **Pre-training**: Virtually _all of the compute_ used during
pre-training[^4].
...
<video
    src="/assets/gpt3-fine-tuning.mp4"
    autoplay
    loop
    muted
    playsinline
...
<video
    src="/assets/hf_assisted_generation.mov"
    controls
...
<video
    src="/assets/hf_assisted_generation2.mov"
    controls
    preload="metadata"></video>
...
<script
    src="https://asciinema.org/a/668460.js"
    id="asciicast-668460"
    async="true"></script>
...
<script
    src="https://asciinema.org/a/668462.js"
    id="asciicast-668462"
    async="true"></script>
...
Wei, Jason, Yi Tay, Rishi Bommasani, et al. 2022. _Emergent Abilities of
Large Language Models_. [https://arxiv.org/abs/2206.07682](https://arxiv.org/abs/2206.07682).

</div>

<div id="ref-yang2023harnessing" class="csl-entry">

Yang, Jingfeng, Hongye Jin, Ruixiang Tang, et al. 2023. _Harnessing the
Power of LLMs in Practice: A Survey on ChatGPT and Beyond_.
...
Yao, Shunyu, Dian Yu, Jeffrey Zhao, et al. 2023. _Tree of Thoughts:
Deliberate Problem Solving with Large Language Models_.
