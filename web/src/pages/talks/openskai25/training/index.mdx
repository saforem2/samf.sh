...
locationUrl: 'https://www.openskai-conference.org/'
---
...
- [🐢 Training on a Single
  Device](#turtle-training-on-a-single-device-1)
- [🐢 Training on a Single
  Device](#turtle-training-on-a-single-device-2)
- [Training on Multiple GPUs: Data
  Parallelism](#training-on-multiple-gpus-data-parallelism)
...
- 📊 Slides @
  [samforeman.me/talks/openskai25/training/slides](https://samforeman.me/talks/openskai25/training/slides)
    - 📄 HTML version:
      [samforeman.me/talks/openskai25/training](https://samforeman.me/talks/openskai25/training)
...
Figure 6: Send global updates back to each GPU. See: [PyTorch /
Distributed Data
...
- Collective Communication:
    ...
    - [Intel oneAPI Collective Communications Library
      (oneCCL)](https://www.intel.com/content/www/us/en/developer/tools/oneapi/oneccl.html#gs.gouznn)
        ...
        > [!WARNING] ⌛ Timeouts
        >
        > - Collective operations have to be called for each `rank` to form
        >   a complete collective operation.
...
Figure 23: **Pre-training**: Virtually _all of the compute_ used during
pre-training[^4].
