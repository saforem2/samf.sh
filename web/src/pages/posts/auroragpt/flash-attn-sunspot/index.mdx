...
date: 2024-06-17
description: 'Debugging flash attention discrepancies on Sunspot and documenting framework comparison results with Intel.'
---
...
<img src="/assets/flash-attn/flash-attn-dropout-fix.png" />
...
seemed to produce different loss curves (with otherwise _identical
configs_)
...
<img src="/assets/flash-attn/flash-attn-bug-q4-drop-sunspot-1.png" />
...
<summary>🎁 <code>frameworks_2024_5_v2</code> Announcement:</summary>
...
<img src="/assets/flash-attn/flash-attn-sunspot-compare-new-release.png" alt="`flash` 📸 🤝 📷
no-`flash`" />
...
[mpi4py-reproducer](../mpi4py-reproducer/), and this \[[slack
...
_most_ of the dependencies are already present in the provided
...
module, which worked without modification and had ) _most_ of what I
...
_why_ the `flash-attn` fix would have _any_ dependence on the learning
rate schedule (warmup + decay).

If the `flash-attn` fix works for a particular learning rate schedule,
you would reasonably expect that it should work for _any_ learning rate
schedule.
...
<img src="/assets/flash-attn/flash-attn-disguise-decay10000-1.png" alt="flash-attn-disguise-decay10000-1" />
Looking at this figure ^, it appears that up until the very very end,
all three loss curves agree _identically_.

However, if we look closely at the very end, it looks like there _might_
be a _slight_ difference beginning to appear between the `2024.0` (brown
...
<img src="/assets/flash-attn/flash-attn-disguise-decay5000.png" alt="flash-attn-disguise-decay5000" />
...
<img src="/assets/flash-attn/flash-attn-disguise-decay-2000.png" alt="flash-attn-disguise-decay-2000" />
<img src="/assets/flash-attn/flash-attn-disguise-decay1500.png" alt="flash-attn-disguise-decay1500" />

<img src="/assets/flash-attn/flash-attn-disguise-decay1000-1.png" alt="flash-attn-disguise-decay1000-1" />
...
<summary>Older Figs</summary>

<img src="/assets/flash-attn/disguised-fix-2.png" alt="disguised-fix-2" />
<img src="/assets/flash-attn/disguised-fix-1.png" alt="disguised-fix-1" />
...
<img src="/assets/flash-attn/flash-attn-2024-0-fix.png" />
<img src="/assets/flash-attn/flash-attn-fix-frameworks-comparison.png" />

### 📊 `lr-decay-iters` Comparison

- `2024.0`:
    - <img src="/assets/flash-attn/decay-experiment-2024-0-1.png" />
- `2024.1`:
    - <img src="/assets/flash-attn/decay-experiment-2024-1.png" />

## 📈 `lr-decay-iters` dependence

<img src="/assets/lr-decay-iters-dependence-2.png" />

<img src="/assets/lr-schedule-dependence.png" />
<img src="/assets/lr-decay-iters-dependence-1.png" />

## 🏎️ Performance Improvement in `2024.1`

<img src="/assets/performance-2024-0.png" />

<img src="/assets/performance-2024-1.png" />
...
[^3]:
    Explicitly, `aurora_nre_models_frameworks-2024.0`, abbreviated as
    `2024.0`

[^4]:
    Intel used the following learning rate schedule in their
    experiments
    `yml   lr: 0.00015   lr-warmup-frac: 0.01   lr-decay-iters: 320000`

[^5]:
    ALCF used the following learning rate schedule in their
    experiments
