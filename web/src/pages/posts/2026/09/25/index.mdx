...
browser ───────────────────── relay.sf.onl
                 ...
                 SSH forwards │          │ Tailcat forwards
                     ...
                     ┌─────────┼──────────────┐
                     │         │              │
                  Tailscale  localhost      SSH jump
                    Serve    services       hosts
                     │         │              │
                     ▼         ▼              ▼
                  browsers   agents       Aurora / CELS
```
...
| Herdr relay       | `mbpr:8375`       | Cloudflare at `relay.sf.onl`                              | Attach a browser to persistent terminal/agent sessions         |
...
The relay binds to loopback on `mbpr`:
...
All three could look “up” in a process list. The acceptance checks need to cross
